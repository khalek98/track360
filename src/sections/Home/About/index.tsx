    ...
    <section className={styles.About} id="about">
      ...
      <div className="container">
        <div className={styles.AboutWrapper}>
          ...
          <Fade bottom>
            <p className={cn(styles.Text, "animate__animated animate__fadeInUp wow")}>
              Track 360 is powered by Proline Ltd, based in Tel Aviv, Israel. Established in 2017,
              Proline has over <span>20 years of R&D experience.</span> Comprised of experienced
              marketers and software developers, Proline is dedicated to providing the best and
              <span>most feature-rich affiliate software</span> on the market.
            </p>
          </Fade>
